...
[TestFixture]
public class SurnameContactTest
{
	...
	public void testimiMbiemritKontakti()
	{
		driver.Navigate().GoToUrl("http://localhost:5174/contact");


		//Gjeni inputin per emrin dhe shenoni emrin
		IWebElement mbiemriKontakti = driver.FindElement(By.XPath("//input[@id='contact-surname']"));
		mbiemriKontakti.SendKeys("Pira");
